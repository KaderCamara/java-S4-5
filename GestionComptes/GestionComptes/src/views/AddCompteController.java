...
public class AddCompteController implements Initializable {
    ...
    private void handleSearchPartenaire(ActionEvent event) {
        oblComptes = Utils.handleSearchPartenaire(txtNci, txtNomPrenom, txtTelephone, txtAdress, txtLogin, txtNci, part, oblComptes, service, tblvCompte, tblcNumero, tblcSolde);
